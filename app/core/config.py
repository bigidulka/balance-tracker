...
class Settings(BaseSettings):
    ...
    auth_context_cache_ttl_seconds: float = Field(default=2.0)
    auth_context_cache_max_entries: int = Field(default=1024)
    ...
    sync_job_stale_recovery_interval_seconds: float = Field(default=60.0)
