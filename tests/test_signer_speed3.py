...
async def test_speed():
    ...
    # Do a dummy call to let it load
    headers = await signer.sign_request("/user/config", {"id": "0x463452c356322d463b84891ebda33daed274cb40"})
    print(f"Init header received: {headers is not None}")
