...
MIN_STABLECOIN_CHANGE = float(os.getenv("MIN_STABLECOIN_CHANGE", "1.0"))  # minimum $1 for stablecoins
MIN_TOKEN_CHANGE_PERCENT = float(os.getenv("MIN_TOKEN_CHANGE_PERCENT", "0.1"))  # 0.1% for other tokens
