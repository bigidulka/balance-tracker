...
const content = fs.readFileSync('tests/debank_js/remote-entry.js', 'utf8');
...
const possibleKeys = [
    '279eda6c-d676-4240-8d01-6cf66607f1c4', // old api key
    '263d40dd-712a-49fe-b288-0d36a4dcf529', // new api key
];
