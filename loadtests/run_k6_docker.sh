...
exec docker run --rm \
  ...
  -e FORCE_REFRESH_RATIO="${FORCE_REFRESH_RATIO:-0}" \
  -e DASHBOARD_METRICS_RATIO="${DASHBOARD_METRICS_RATIO:-0.25}" \
  -e DASHBOARD_UTC_OFFSET_MINUTES="${DASHBOARD_UTC_OFFSET_MINUTES:-180}" \
